                ...
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa fa-group"></i> Administracion <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            ...
                            <li><a href="{{ route('users.create') }}"> Usuarios</a></li>
                            <li><a href="{{ route('proyecto.create') }}">Proyectos</a></li>
                            <li><a href="{{ route('tipo.create') }}">Tipos de Terreno</a></li>
                            <li><a href="{{ route('map.index') }}">Terrenos</a></li>
